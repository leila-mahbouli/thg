...
<body>
    ...
    <center>
<table>
    <td><img src="ASPIRATEUR%20MOBILE.jpg" class="bt"> </td>
    
    <td>
      <center><h2>Aspirateur Mobile</h2></center><br><br> 
    <form>
    <div class="nativeDatePicker">
      <label for="start">Veuillez saisir la date de location :</label>
...
<input type="date" id="start" name="Date"
    ...
    <div class="fallbackDatePicker">
      <span>
        <label for="day"><p>Veuillez saisir le nombre de jour:</p></label>
        <input type="number" step="1" value="0" name="Nbjour" min="1" max="360">
      </span>
      
    </div>
        
        <div>
    <input type="submit" value="Réserver" class="reserver" name="submit">
        </div></div>
</form>
    </td>
</table>    
   ...
   <br><br>
<section>
    <h2 class="bt">Description</h2> <br>
    <p>Aspirateur compact sur chariot mobile à roues pivotantes dont 2 avec freins, avec poignet de manœuvre.</p>
</section>    
    <br><br><br><br>
