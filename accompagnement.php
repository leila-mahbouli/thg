...
<body>
    ...
    <section>
        <h1 class="tbk__title" itemprop="headline">Service de transport <br>et accompagnement à la sortie d’hospitalisation </h1>
        <p>Pour vous fournir un accompagnement à la sortie, <strong>THG Assistance</strong> propose un service de <strong>réservation d'ambulances</strong> pour les patients alités ou <strong>non ambulatoires</strong> et non transportables par d'autres moyens.</p>
        <p>Notre plateforme de réservation de <strong>consultations à domicile</strong>, de <strong>soins infirmiers</strong> et d’<strong>équipements médicaux</strong>&nbsp;permet également de prévoir le <strong>transport non urgent des malades post-opératoire</strong> par exemple.</p>
        <p>En cas d’urgence veuillez contacter les secours sur les numéros d’urgence en Tunisie, le 190 pour le SAMU, le 198 pour la Protection Civile, le 197 pour Police Secours et le 71 725 555 ou le 71 599 900 pour SOS Ambulances.</p>
        
    </section>
    
    
    <h1 class="tbk__title" itemprop="headline">Demander un service </h1>
               <br><br>
    <div class="bouton"> <center>

   <a href="ambulance.php">Ambulance</a>
   <br> <div class="bouton"><a href="aide a dom.php">Aide à domicile</a></div> 
    </center>
    </div>
    <br><br>
