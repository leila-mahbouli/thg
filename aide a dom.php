...
<body>
    ...
    <section>
     ...
     <table align="center">
             ...
             <tr>
                 <td>
    <legend>Aide à domicile</legend><br><br>
...
       <td><select name="praticien">
           <option value="Responsable Accompagnement à la sortie" selected>Responsable Accompagnement à la sortie</option></select></td>
        </tr>
        <tr>
